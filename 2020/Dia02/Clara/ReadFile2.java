  ...
  public static void main(String[] args) {
    try {
      ...
      while (myReader.hasNextLine()) {
        ...
        String maxLetter=password.substring(max-1, max);
        String minLetter=password.substring(min-1, min);


        if ((maxLetter.equals(letter) && !minLetter.equals(letter)) ||
            (!maxLetter.equals(letter) && minLetter.equals(letter)) ){
